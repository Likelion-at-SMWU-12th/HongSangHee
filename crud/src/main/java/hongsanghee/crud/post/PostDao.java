...
import hongsanghee.crud.entity.PostEntity;
import hongsanghee.crud.respository.PostRepository;
...
public class PostDao {
    ...
    public PostEntity readPost(int id){
        ...
        if(postEntity.isEmpty()){ //java 11부터 지원되는 메소드로 java 8버전에 맞게 수정해보았습니다.
    ...
    public void updatePost(int id, PostDto dto){
        ...
        if(targetEntity.isEmpty()){ //java 11부터 지원되는 메소드로 java 8버전에 맞게 수정해보았습니다.
            throw new ResponseStatusException(HttpStatus.NOT_FOUND);
        }
